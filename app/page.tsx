        ...
        <div className="bg-white/50 border border-hairline rounded-lg p-8 md:p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3 bg-crimson text-paper rounded-lg font-body font-semibold hover:bg-crimson/90 transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3 border-2 border-gold text-ink rounded-lg font-body font-semibold hover:bg-gold/10 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <p className="mt-4 text-sm text-ink-muted">
            bossaboys.connect@gmail.com · +1 (519) 702-8217
          </p>
        </div>
      </section>
